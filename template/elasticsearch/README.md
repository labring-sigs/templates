...
GitHub - elastic/start-local: Try Elasticsearch and Kibana locally is the source of truth.
////
...
xref:elasticsearch/docs/README.md at main · elastic/elasticsearch[docs README].

[[examples]]
== Examples and guides

The GitHub - elastic/elasticsearch-labs: Notebooks & Example Apps for Search & AI Applications with Elas[`elasticsearch-labs`] repo contains executable Python notebooks, sample apps, and resources to test out Elasticsearch for vector search, hybrid search and generative AI use cases.

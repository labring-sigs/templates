...
The Sealos template includes all required dependencies: Supabase Studio, Kong gateway, GoTrue Auth, PostgREST, Realtime, Storage API, Imgproxy, Postgres Meta, Edge Runtime, Logflare analytics, Vector log pipeline, Supavisor connection pooling, and a managed PostgreSQL 14.8 cluster.

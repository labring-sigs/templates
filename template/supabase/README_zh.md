...
该 Sealos 模板已包含完整依赖：Supabase Studio、Kong 网关、GoTrue Auth、PostgREST、Realtime、Storage API、Imgproxy、Postgres Meta、Edge Runtime、Logflare 分析组件、Vector 日志管道、Supavisor 连接池，以及托管的 PostgreSQL 14.8 集群。
